...
\declareFig{threshold_hc}{Comparison of continuous and discrete gating on the sparsity-loss tradeoff}{}

\declareFig{threshold_cmp}{Impact of local cache on the sparsity-loss tradeoff}{Removing local cache leads to a sharp surge in distillation loss.}
...
\declareTab{replay}
  {Average last-layer hidden states MSE under different admission policies}
  {}
  {
    \begin{tabular}{ccc}
      \toprule
